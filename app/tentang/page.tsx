import anggotaKelompok from "@/kelompok";
    ...
    <div className="container p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:grid-cols-3">
        {anggotaKelompok.map((anggota) => (
          <div key={anggota.npm} className="p-4 border border-gray-300 shadow-sm rounded-lg">
            {anggota.website ? (
              <Image
            ...
            <div className="mt-4 text-center">
              <h3 className="text-lg/tight font-semibold text-heading">{anggota.nama}</h3>

              <p className="mt-0.5 text-sm">{anggota.npm}</p>
